...
class RefConLightning(pl.LightningModule):
    ...
    def forward(self, anchors, positives, negatives):
        anchors_embed = self.model(pixel_values=anchors)
        positives_embed = self.model(pixel_values=positives)
        negatives_embed = self.model(pixel_values=negatives)
...
if __name__ == '__main__':
    ...
    dataset = md.get_base_dataset()
    train_indices, val_indices = md.get_train_val_indices(wandb_config, dataset)
